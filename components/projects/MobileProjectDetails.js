...
const MobileProjectDetails = ({ name, desc, tech, url, github }) => {
  return (
    <div className="max-w-xl mx-auto rounded flex flex-col sm:flex-row justify-between">
      <div className="pt-1">
      ...
      <div className="">
        <p className="max-w-xs mx-auto text-gray-300 leading-loose text-base">
          {desc}
        </p>
