      ...
      <div className="py-20 bg-gray-900 radius-for-skewed">
        <div className="container px-4 mx-auto">
          <div className="mb-16 flex flex-wrap justify-center md:justify-between items-center">
            ...
            <a className="hidden md:inline-block py-2 px-6 rounded-l-xl rounded-t-xl bg-purple-600 hover:bg-purple-700 text-gray-50 font-bold leading-loose transition duration-200">
              View More Projects
            </a>
          </div>
          ...
          <div className="text-center">
            <a className="md:hidden inline-block py-2 px-6 rounded-l-xl rounded-t-xl bg-purple-600 hover:bg-purple-700 text-gray-50 font-bold leading-loose transition duration-200">
              View More Projects
            </a>
          </div>
        </div>
